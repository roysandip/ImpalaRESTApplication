...
public class ImpalaRESTService {
	...
	public String produceJSON(@PathParam("query") String sqlQuery) {
		...
		// For POC purpose credetials and impala instances are hard-coded
		String connectionUrl = "jdbc:impala://your_impala_host:21050/default;AuthMech=3;UID=xxx;PWD=xxx";
